...
class MedicalHistoriesController extends Controller
{
    ...
    {
        $medicalHistories = MedicalHistories::with('previous_treatments', 'surgical_procedures')->where('pet_id', $request->pet_id)->get();
        $medicalHistoriesPet = [];
        $previous_treatments = [];
        $surgical_procedures = [];
     ...
     */
    public function store(StoreMedicalHistoriesRequest $request)
    {
        //
